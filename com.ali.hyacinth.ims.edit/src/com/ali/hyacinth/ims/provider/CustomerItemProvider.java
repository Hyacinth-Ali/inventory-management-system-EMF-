...
/**
 * This is the item provider adapter for a {@link com.ali.hyacinth.ims.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerItemProvider extends PersonRoleItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDebtPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Debt feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDebtPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Customer_debt_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Customer_debt_feature", "_UI_Customer_type"),
				 ImsPackage.Literals.CUSTOMER__DEBT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ImsPackage.Literals.CUSTOMER__CUSTOMER_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Customer_type") + " " + customer.getDebt();
	}
