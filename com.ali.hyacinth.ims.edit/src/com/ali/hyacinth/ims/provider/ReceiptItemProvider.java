...
/**
 * This is the item provider adapter for a {@link com.ali.hyacinth.ims.Receipt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReceiptItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Receipt_transaction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Receipt_transaction_feature", "_UI_Receipt_type"),
				 ImsPackage.Literals.RECEIPT__TRANSACTION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Receipt_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Receipt_date_feature", "_UI_Receipt_type"),
				 ImsPackage.Literals.RECEIPT__DATE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Date labelValue = ((Receipt)object).getDate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Receipt_type") :
