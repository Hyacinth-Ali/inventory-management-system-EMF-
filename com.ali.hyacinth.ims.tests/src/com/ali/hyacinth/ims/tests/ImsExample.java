...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ims</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new ImsResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(ImsPackage.eNS_URI, 
			 ImsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ims"));
				Product root = ImsFactory.eINSTANCE.createProduct();
