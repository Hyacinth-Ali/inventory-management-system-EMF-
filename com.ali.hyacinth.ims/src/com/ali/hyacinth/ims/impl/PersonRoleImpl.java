 ...
 * </p>
 * <ul>
 *   <li>{@link com.ali.hyacinth.ims.impl.PersonRoleImpl#getPerson <em>Person</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PersonRoleImpl extends MinimalEObjectImpl.Container implements PersonRole {
	...
	protected EClass eStaticClass() {
		return ImsPackage.Literals.PERSON_ROLE;
	}
		...
		if (person != null && person.eIsProxy()) {
			...
			if (person != oldPerson) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ImsPackage.PERSON_ROLE__PERSON, oldPerson, person));
			}
		}
		return person;
	}
	...
	public NotificationChain basicSetPerson(Person newPerson, NotificationChain msgs) {
		...
		person = newPerson;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ImsPackage.PERSON_ROLE__PERSON, oldPerson, newPerson);
	...
	public void setPerson(Person newPerson) {
		if (newPerson != person) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ImsPackage.PERSON_ROLE__PERSON, newPerson, newPerson));
	}
